...
{
	public partial class AnalyticsKitchenViewController : BaseViewController<KitchenAnalysisViewModel>, IUITableViewDataSource
	{
		...
		public AnalyticsKitchenViewController(IntPtr handle) : base(handle)
		{
		}
		...
		public UITableViewCell GetCell(UITableView tableView, NSIndexPath indexPath)
		{
			if (tableView == this.previousReportTableView)
			{
				KitchenPreviousReportDataRowCell cell = (KitchenPreviousReportDataRowCell)tableView.DequeueReusableCell("KitchenPreviousReportDataRowCell", indexPath);
				cell.KitchenNameLabel.Text = ((DataRowUnit)ViewModel.PreviousDataTable.Rows[indexPath.Row]).Data[0];
				cell.TotalElectroluxLabel.Text = ((DataRowUnit)ViewModel.PreviousDataTable.Rows[indexPath.Row]).Data[1];
				cell.TotalOtherLabel.Text = ((DataRowUnit)ViewModel.PreviousDataTable.Rows[indexPath.Row]).Data[2];
				cell.TotalOverallLabel.Text = ((DataRowUnit)ViewModel.PreviousDataTable.Rows[indexPath.Row]).Data[3];
			...
			{
				KitchenComparisonDataRowCell cell = (KitchenComparisonDataRowCell)tableView.DequeueReusableCell("KitchenComparisonDataRowCell", indexPath);
				cell.KitchenNameLabel.Text = ((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Data[0];
				cell.TotalElectroluxLabel.AttributedText = formatAttributedString(((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Data[1],
																			  ((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Percent[1]);
				cell.TotalOtherLabel.AttributedText = formatAttributedString(((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Data[2],
																			  ((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Percent[2]);
				cell.TotalOverallLabel.AttributedText = formatAttributedString(((DataRowUnit)ViewModel.LastDataTable.Rows[indexPath.Row]).Data[3],
